...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost:8888/g5_wordpress/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	styleDestination: './assets/styles/custom/', // Path to place the compiled CSS file. Default set to root folder.
	...
	jsCustomDestination: './assets/scripts/custom/', // Path to place the compiled JS custom scripts file.
	...
	// Watch files paths.
	watchStyles: './assets/styles/**/*.scss', // Path to all *.scss files inside styles folder and inside them.
	...
	// Translation options.
	textDomain: 'wp', // Your textdomain here.
	translationFile: 'wp.pot', // Name of the translation file.
